        ...
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full py-3 px-4 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold rounded-lg border border-blue-200 transition-colors flex items-center justify-center"
            >
              <span className="mr-2">👤</span> I am a Patient
            </button>
            <button
              onClick={() => setRole("MEDIC")}
              className="w-full py-3 px-4 bg-purple-50 hover:bg-purple-100 text-purple-700 font-semibold rounded-lg border border-purple-200 transition-colors flex items-center justify-center"
            >
              <span className="mr-2">👨‍⚕️</span> I am a Medic
            </button>
            <button
              onClick={() => setRole("ATTENDANT")}
              className="w-full py-3 px-4 bg-orange-50 hover:bg-orange-100 text-orange-700 font-semibold rounded-lg border border-orange-200 transition-colors flex items-center justify-center"
            >
            ...
            <div className="pt-4 border-t border-gray-100 grid grid-cols-1 gap-2">
              <button
                ...
                className="py-2 px-4 text-gray-600 hover:text-gray-800 text-sm font-medium transition-colors border border-gray-200 rounded-lg hover:bg-gray-50"
              >
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="py-2 px-4 text-gray-500 hover:text-gray-700 text-sm font-medium transition-colors border border-gray-200 rounded-lg hover:bg-gray-50"
                >
                  🖥️ Kiosk Mode
                </button>
                <button
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="text-2xl font-bold tracking-tight mr-4">
              OpenClinic
            </h1>
      ...
      <footer className="bg-gray-800 text-gray-400 py-8 mt-12">
        <div className="container mx-auto px-6 text-center">
          <p>
            &copy; {new Date().getFullYear()} OpenClinic System. All rights
            reserved.
          </p>
        </div>
      </footer>

...
import type { AttendantResponseDTO, AttendantRequestDTO } from "../types/api";
...
const AttendantList: React.FC = () => {
  ...
  const [editingAttendant, setEditingAttendant] =
    useState<AttendantResponseDTO | null>(null);
  ...
  if (loading && attendants.length === 0)
    return (

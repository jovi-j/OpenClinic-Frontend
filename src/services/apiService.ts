...
export const ApiService = {
  ...
  redirectTicket: async (
    id: string,
    data: TicketRedirectDTO,
  ): Promise<TicketResponseDTO> => {
  ...
  createTicketQueue: async (
    data: TicketQueueRequestDTO,
  ): Promise<TicketQueueResponseDTO> => {
    const response = await fetch(`${BASE_URL}/ticket-queues`, {
      method: "POST",
      headers,
      body: JSON.stringify(data),
  ...
  callNextTicket: async (
    data: TicketQueueCallNextRequestDTO,
  ): Promise<TicketResponseDTO> => {
    const url = new URL(
  ...
  updateMedic: async (
    id: string,
    data: MedicRequestDTO,
  ): Promise<MedicResponseDTO> => {
    const response = await fetch(`${BASE_URL}/medics/${id}`, {
      method: "PATCH",
      headers,
      body: JSON.stringify(data),
  ...
  createAttendant: async (
    data: AttendantRequestDTO,
  ): Promise<AttendantResponseDTO> => {
    const response = await fetch(`${BASE_URL}/attendants`, {
      method: "POST",
      headers,
      body: JSON.stringify(data),
  ...
  scheduleAppointment: async (
    ...
    const response = await fetch(
      `${BASE_URL}/appointments/scheduleAppointment`,
      {
        method: "PATCH",
        headers,
        body: JSON.stringify(data),
  ...
  getAvailableAppointmentsByMedic: async (
    medicId: string,
  ): Promise<GroupedAppointmentsDTO[]> => {
    const response = await fetch(
      `${BASE_URL}/appointments/availableByMedic/${medicId}`,
      { method: "GET", headers },
    );
  ...
  searchAppointments: async (
    ...
    const response = await fetch(
      `${BASE_URL}/appointments/search?${params.toString()}`,
      { method: "GET", headers },
    );
